...
const DESCRIBE: &str = r#"{
  ...
  "provenance_limitations": [
      ...
      "NOT A SIGN-OFF GATE YET. Correlated against OpenROAD check_antennas on a routed sky130 block: 37 of 38 compared ratio values within 2%, 6 unconfirmed violations, but only 37 of 83 real violations found. Where it produces a number the number is right; recall is the gap. A flagged net is strong evidence, a clean run is weak evidence.",
      ...
      "Diffusion area is accumulated net-wide; OpenROAD accumulates it per conductor. A net-wide total is never smaller, so the diffusion-dependent limit comes out too high and violations slip under it — the cause of the missed violations above.",
